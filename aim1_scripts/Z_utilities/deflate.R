...
##'
##' Description:
##' This script provides a copy of the standard DEX deflator function,
##' originally developed by Sawyer Crosby (“crosbys”).
##' Source: https://stash.ihme.washington.edu/projects/FRH/repos/dex_us_county/browse/R/deflate.R
##'
...
deflate <- function(
  ...
  ## get deflators
  deflators <- fread("/ihme/dex/us_county/deflators/best.csv")
