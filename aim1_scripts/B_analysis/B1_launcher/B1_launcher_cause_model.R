##----------------------------------------------------------------
## Title: B1_launcher_two_part_model.R  (by-cause array)
##----------------------------------------------------------------
...
bootstrap_iterations_RX  <- 2

jid <- SUBMIT_ARRAY_JOB(
  name       = "B1_two_part_by_cause",
  script     = script_path,
  ...
  memory     = "60G",         # often enough per cause; adjust if needed
  threads    = 1,
  time       = "08:00:00",    # adjust per dataset size/boots
