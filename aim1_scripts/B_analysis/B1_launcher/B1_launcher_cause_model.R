...
# NOTES FOR DATA
# These cause*year combos seem to have issues running and don't produce results.

#"Cause_name: _infect Year_id: 2010" - has_0 & has_1 both "gamma failed" for all bootstraps
#"Cause_name: _ri Year_id: 2014" - has_0 & has_1 both "gamma failed" for all bootstraps
