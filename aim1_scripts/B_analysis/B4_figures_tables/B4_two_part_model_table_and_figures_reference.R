##----------------------------------------------------------------
##' Title: B4_two_part_model_table_and_figures.R
##'
##' Purpose: ChatGPT suggestions for figures, can be used as reference tables. Needs slight rework to get functional
##'
##' Outputs: TBD
##'
